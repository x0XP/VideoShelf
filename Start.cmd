...
if exist "VideoShelfInstallerLogo.bmp.b64" (
 powershell -NoProfile -ExecutionPolicy Bypass -Command "$b=[Convert]::FromBase64String((Get-Content -Raw 'VideoShelfInstallerLogo.bmp.b64')); [IO.File]::WriteAllBytes((Join-Path (Get-Location) 'VideoShelfInstallerLogo.bmp'),$b)"
 if errorlevel 1 (
