...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0build\Branding\BuildBrandAssets.ps1"
if errorlevel 1 (
...
"%CSC%" /nologo /target:winexe /optimize+ /win32icon:"VideoShelfApp.ico" /out:"VideoShelf.exe" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Net.Http.dll /reference:System.Web.Extensions.dll /reference:System.Xml.Linq.dll /reference:System.Security.dll "src\VideoShelf\Infrastructure\AppDataPaths.cs" "src\VideoShelf\Branding\AppBrand.cs" "src\VideoShelf\UI\Theme\XdolfTheme.cs" "src\VideoShelf\UI\Controls\MockupControls.cs" "src\VideoShelf\UI\Controls\MockupActionButton.cs" "src\VideoShelf\UI\Controls\MockupFilter.cs" "src\VideoShelf\Infrastructure\FolderManagement.cs" "src\VideoShelf\Media\TransferBridge.cs" "src\VideoShelf\Media\LibraryMediaIntelligence.cs" "src\VideoShelf\Application\AppVersion.cs" "src\VideoShelf\Application\UpdateService.cs" "src\VideoShelf\Application\VideoShelf.cs" "src\VideoShelf\Diagnostics\ScreenshotHarness.cs" "src\VideoShelf\UI\Shelf\Shelf.Core.cs" "src\VideoShelf\UI\Shelf\Shelf.Branding.cs" "src\VideoShelf\UI\Shelf\Shelf.HomeDashboard.cs" "src\VideoShelf\UI\Shelf\Shelf.Layout.cs" "src\VideoShelf\UI\Shelf\Shelf.Visuals.cs" "src\VideoShelf\UI\Shelf\Shelf.Polish.cs" "src\VideoShelf\UI\Shelf\Shelf.Library.cs" "src\VideoShelf\UI\Shelf\Shelf.Online.cs" "src\VideoShelf\UI\Shelf\Shelf.Updates.cs" "src\VideoShelf\UI\Shelf\UpdateProgressForm.cs" "src\VideoShelf\Search\PortraitLookup.cs" "src\VideoShelf\Search\OnlineSearch.cs" "src\VideoShelf\Search\BuiltInOnlineSearch.cs" "src\VideoShelf\Search\SearchRelevance.cs" "src\VideoShelf\Search\OnlineThumbnailLookup.cs"
if errorlevel 1 (
 echo Build failed.
 exit /b 1
)
