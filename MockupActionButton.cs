...
sealed class MockupActionButton : Control {
 ...
 bool hot,pressed;
 public MockupActionButton(){Cursor=Cursors.Hand;TabStop=true;SetStyle(ControlStyles.AllPaintingInWmPaint|ControlStyles.OptimizedDoubleBuffer|ControlStyles.ResizeRedraw|ControlStyles.UserPaint|ControlStyles.Selectable,true);}
 protected override void OnPaint(PaintEventArgs e){
  ...
  using(var f=UiPaint.IconFont(21f))TextRenderer.DrawText(g,Glyph,f,new Rectangle(18,12,38,38),iconColor,TextFormatFlags.HorizontalCenter|TextFormatFlags.VerticalCenter|TextFormatFlags.NoPadding);
  using(var f=new Font("Segoe UI",11.6f,FontStyle.Bold))TextRenderer.DrawText(g,TitleText,f,new Rectangle(68,10,Width-80,25),Enabled?Color.White:Color.FromArgb(120,130,140),TextFormatFlags.SingleLine|TextFormatFlags.EndEllipsis|TextFormatFlags.NoPadding);
  using(var f=new Font("Segoe UI",8.5f,FontStyle.Regular))TextRenderer.DrawText(g,SubtitleText,f,new Rectangle(68,37,Width-80,18),Enabled?Color.FromArgb(205,217,229):Color.FromArgb(95,106,116),TextFormatFlags.SingleLine|TextFormatFlags.EndEllipsis|TextFormatFlags.NoPadding);
  if(Focused)ControlPaint.DrawFocusRectangle(g,new Rectangle(5,5,Width-10,Height-10));
 }
 protected override void OnMouseEnter(EventArgs e){hot=true;Invalidate();base.OnMouseEnter(e);}protected override void OnMouseLeave(EventArgs e){hot=false;pressed=false;Invalidate();base.OnMouseLeave(e);}protected override void OnMouseDown(MouseEventArgs e){if(e.Button==MouseButtons.Left&&Enabled){pressed=true;Invalidate();}base.OnMouseDown(e);}protected override void OnMouseUp(MouseEventArgs e){pressed=false;Invalidate();base.OnMouseUp(e);}protected override void OnEnabledChanged(EventArgs e){Invalidate();base.OnEnabledChanged(e);}protected override void OnGotFocus(EventArgs e){Invalidate();base.OnGotFocus(e);}protected override void OnLostFocus(EventArgs e){Invalidate();base.OnLostFocus(e);}
