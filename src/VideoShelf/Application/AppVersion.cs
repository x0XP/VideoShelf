...
static class AppVersion {
 public const string Current="1.7.10";
 ...
 public static void SelfTest(){
  if(!IsNewer("v1.7.11")||!IsNewer("2.0.0")||IsNewer("1.7.10")||IsNewer("1.7.9"))throw new InvalidOperationException("Application version comparison self-test failed.");
