...
static class AppVersion {
 public const string Current="1.7.14";
 ...
 public static void SelfTest(){
  if(!IsNewer("v1.7.15")||!IsNewer("2.0.0")||IsNewer("1.7.14")||IsNewer("1.7.13"))throw new InvalidOperationException("Application version comparison self-test failed.");
